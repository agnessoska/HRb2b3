-- Миграция 0069: Добавление локализованного названия категории в результаты get_organization_candidates
-- Проблема: Функция возвращает только category_id (UUID), что приводит к отображению UUID вместо названия
