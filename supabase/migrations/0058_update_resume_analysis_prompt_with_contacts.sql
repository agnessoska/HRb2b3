-- Обновляем промпт для анализа резюме, добавляя извлечение контактных данных, опыта и последней роли
UPDATE ai_prompts
...
2.  **Professional Info**: Определи общий стаж работы в годах (число) и последнюю занимаемую должность.
3.  **Executive Summary**: Дай краткую, емкую характеристику (2-3 предложения). Кто этот человек профессионально?
4.  **Match Score**: Объективно оцени соответствие требованиям (0-100%). Будь строг.
5.  **Hard Skills**: Выдели ключевые сильные стороны и КРИТИЧЕСКИЕ пробелы (чего не хватает для вакансии).
6.  **Soft Skills**: Оцени "мягкие навыки" на основе опыта и стиля описания (коммуникация, лидерство, инициативность).
7.  **Cultural Fit**: Насколько кандидат впишется в корпоративную культуру (судя по тону резюме, хобби, волонтерству).
8.  **Red Flags**: Найди скрытые риски (частая смена работы, пробелы, понижение в должности, неряшливость, общие фразы).
9.  **Interview Strategy**: Придумай 3 острых вопроса, чтобы проверить слабые места или подтвердить сильные.
  ...
  "candidates": [
    {
      ...
      "last_position": "Senior Frontend Developer",
      "match_score": 85,
