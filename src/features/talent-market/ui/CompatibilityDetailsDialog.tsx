...
const ComparisonCard = ({ name, description, match, ideal, candidate, t }: { name: string, description: string, match: number, ideal: number, candidate: number, t: (key: string) => string }) => (
  <Card className="p-4">
...
const BigFiveComparison = ({ details, t, tTests }: { details: Record<string, ScaleComparison>, t: (key: string) => string, tTests: (key: string) => string }) => {
  const scales = [
...
const MBTIComparison = ({ details, t, tTests }: { details: { ideal: string; candidate: string; match: number }, t: (key: string) => string, tTests: (key: string) => string }) => {
...
const DISCComparison = ({ details, t, tTests }: { details: Record<string, ScaleComparison>, t: (key: string) => string, tTests: (key: string) => string }) => {
  const scales = [
...
const EQComparison = ({ details, t, tTests }: { details: Record<string, ScaleComparison>, t: (key: string) => string, tTests: (key: string) => string }) => {
  const scales = [
...
const SoftSkillsComparison = ({ details, t, tTests }: { details: Record<string, ScaleComparison>, t: (key: string) => string, tTests: (key: string) => string }) => {
  const scales = [
...
const MotivationComparison = ({ details, t, tTests }: { details: Record<string, ScaleComparison>, t: (key: string) => string, tTests: (key: string) => string }) => {
  const scales = [
